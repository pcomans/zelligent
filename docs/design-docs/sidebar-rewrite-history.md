# Persistent Sidebar Rewrite History
...
This file is retained as implementation history. The current CLI layout
contract lives in `docs/design-docs/sidebar-layout-contract.md`.
